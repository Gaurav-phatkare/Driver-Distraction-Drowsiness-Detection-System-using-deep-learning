...
path = os.getcwd()
cap = cv2.VideoCapture(0)  # Change to 0 for default camera or 1 for external camera
...
zoom_factor = 1.2  # Adjust the zoom factor as needed
...
while True:
    ...
    frame = cv2.resize(frame, (int(width / zoom_factor), int(height / zoom_factor)))
